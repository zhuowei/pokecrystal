...
pokecrystal_opt         = -Cj -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x1b -r 3 -p 0 -f hg
pokecrystal11_opt       = -Cj -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x1b -r 3 -p 0 -f hg
